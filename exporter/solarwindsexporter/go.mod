...
require (
	...
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/testutil v0.127.1
...
require (
	...
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/version v0.127.1 // indirect
