...
require (
	github.com/solarwinds/solarwinds-otel-collector-contrib/extension/solarwindsextension v0.0.1
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/testutil v0.0.1
...
require (
	...
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/version v0.0.1 // indirect
