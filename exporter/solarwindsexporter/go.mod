...
require (
	github.com/solarwinds/solarwinds-otel-collector-contrib/extension/solarwindsextension v0.123.8
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/testutil v0.123.8
...
require (
	...
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/version v0.123.8 // indirect
