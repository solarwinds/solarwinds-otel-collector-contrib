...
require (
	github.com/solarwinds/solarwinds-otel-collector-contrib/extension/solarwindsextension v0.0.3
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/testutil v0.0.3
...
require (
	...
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/version v0.0.3 // indirect
