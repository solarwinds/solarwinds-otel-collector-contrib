...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			defaultMetricsCount++
			allMetricsCount++
			mb.RecordSwoHardwareinventoryCPUDataPoint(ts, 1, "processor.caption-val", "processor.cores-val", "processor.manufacturer-val", "processor.model-val", "processor.name-val", "processor.socket_id-val", "processor.stepping-val", "processor.threads-val")
			...
			for _, mi := range allMetricsList {
				...
				case "swo.hardwareinventory.cpu":
					...
					processorSocketIDAttrVal, ok := dp.Attributes().Get("processor.socket_id")
					assert.True(t, ok)
					assert.Equal(t, "processor.socket_id-val", processorSocketIDAttrVal.Str())
