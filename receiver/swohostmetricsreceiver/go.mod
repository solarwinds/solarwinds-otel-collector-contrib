...
require (
	...
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/registry v0.136.5
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/testutil v0.136.5
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/version v0.136.5
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/wmi v0.136.5
