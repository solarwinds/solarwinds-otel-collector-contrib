...
require (
	...
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/registry v0.152.7
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/testutil v0.152.7
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/version v0.152.7
	github.com/solarwinds/solarwinds-otel-collector-contrib/pkg/wmi v0.152.7
